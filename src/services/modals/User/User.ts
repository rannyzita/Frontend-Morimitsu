...
export async function fetchObterUsuarioDetalhado(id: string | null, token?: string):Promise<UsuarioDetalhadoResponse> {
...
export async function fetchHistoricoGraduacao(alunoId: string | null, token?: string): Promise<HistoricoGraduacao[]> {
